      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <Accordion type="single" collapsible className="max-w-3xl mx-auto">
          <AccordionItem value="q1" className="border-white/10">
            <AccordionTrigger className="hover:text-yellow-400">What are custom software development solutions?</AccordionTrigger>
          ...
          <AccordionItem value="q2" className="border-white/10">
            <AccordionTrigger className="hover:text-yellow-400">Are you a software development company in Malaysia?</AccordionTrigger>
            <AccordionContent className="text-gray-300">
          ...
          <AccordionItem value="q3" className="border-white/10">
            <AccordionTrigger className="hover:text-yellow-400">How do custom business systems improve efficiency?</AccordionTrigger>
            <AccordionContent className="text-gray-300">
          ...
          <AccordionItem value="q4" className="border-white/10">
            <AccordionTrigger className="hover:text-yellow-400">Can you integrate with existing platforms?</AccordionTrigger>
            <AccordionContent className="text-gray-300">
          ...
          <AccordionItem value="q5" className="border-white/10">
            <AccordionTrigger className="hover:text-yellow-400">How do you approach cost optimization?</AccordionTrigger>
            <AccordionContent className="text-gray-300">
